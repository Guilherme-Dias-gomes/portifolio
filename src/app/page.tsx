export default function Home() {
  return (
    <div className="p-0">
      ...
      <section className="flex bg-cyan-700 text-white w-1/1 h-screen flex-row justify-around font-sans">
      ...
      <section className="flex bg-zinc-700 w-full h-screen text-white items-center flex-col font-sans">
        <h1 className="text-4xl m-10 font-bold">About Me</h1>
        <p className="w-3/4 text-2xl mb-10 text-center">
